...
%                              0 0 0 1]*X + [0;0;n];
        ...
        function self = update(self,X,z)
            if self.obs
                ...
                self.avg_wghts = ones(1,self.NP)/self.NP;
        ...
        function self = unanimate(self)
            self.plotHandle.XData = [];
            self.plotHandle.YData = [];
        end
    end
end